...
wget https://github.com/HandBrake/HandBrake/releases/download/1.3.1/HandBrakeCLI-1.3.1-win-x86_64.zip -OutFile HandBrakeCLI.zip
wget https://ffmpeg.zeranoe.com/builds/win64/static/ffmpeg-20200121-fc6fde2-win64-static.zip -OutFile ./ffmpeg.zip
wget https://get.filebot.net/filebot/FileBot_4.8.5/FileBot_4.8.5_x64.msi -OutFile ./FileBot_4.8.5_x64.msi
...
start .\PREREQS\FileBot_4.8.5_x64.msi
