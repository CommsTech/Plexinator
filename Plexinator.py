...
# ------------------------------------------------------------------------------------------------------------------------
    ...
    if path.is_file():
        subprocess.call(FFMPEGCHECK)
    else:
        subprocess.call(PREREQINSTALL)    

def PREREQINSTALL():
    print(
    '''
We cant find Handbreakcli and/ or ffmpeg?
...
def ADDITIONALINFO ():
    HANDBRAKE_CLI = print("Enter the full handbreakcli.exe location ex: X:\mine\handbreakcli.exe here: ")
    FFMPG = print("Enter the full ffmpeg.exe location ex: X:\mine\ffmpeg.exe here: ")
    FFPROB = print("Enter the full ffprobe.exe location ex: X:\mine\ffprobe.exe here: ")
    FILEBOT = print("Enter the full filebot.exe location ex: X:\mine\filebot.exe here: ")

def BEGIN ():
    OUTPUT_DIR = print("Enter your Video file output directory here: ")
    ...
    if int(THREADA) <= 1:
        THREADA = 0
    THREADS = print("Enter the number of threads you want to use We recommend THREADA ") 
    THREADS = THREADA
    if int(THREADS) >= 5: 
        THREADL=4

def VFDIR():
    WORK_DIR = print("What is the directory of your video files ")
...
menu = {}
menu['1']="Movies (HQ 1080p W/ AAC and AC3 Tracks) Pic Qual Very High" 
menu['2']="TV Shows (HQ 720p W/ AAC and AC3 Tracks) Pic Qual High"
menu['3']="Anime (720p W/ AAC Track) Pic Qual Standard"
menu['4']="Live Sports (1080p W/ AAC Track) Pic Qual Average"
menu['5']="Any YIFY Settings (1080p W/AAC Track) Pic Qual High (smaller size)"
menu['6']="Exit"
while True: 
  options=menu.keys()
  options.sort()
...
menu = {}
menu['1']="By the numbers" 
menu['2']="Automagic"
menu['3']="Attempt to share the wealth with other computers Automagically (coming soon)"
menu['4']="Exit"
...
def Submenu():
    ...
    menu['5'] = "Tester"
    menu['6'] = "Automagic"
    menu['7'] = "New Video Folder"
    menu['8'] = "Additional Tools"
    menu['9'] = "MKV 2 MP4"
    while True: 
        options=menu.keys()
        options.sort()
...
menu = {}
menu['1']="Spit an Episode" 
menu['2']="Reduce all Videos in folder Size (.mp4)"
menu['3']="Exit"
