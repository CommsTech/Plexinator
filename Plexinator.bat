...
SET /P PREREQ=
<<<<<<< HEAD
IF %PREREQ%==1 Powershell.exe -Scope Process -ExecutionPolicy Bypass -File PREREQS\PreReq_Downloader.ps1 
...
Powershell.exe -Scope Process -ExecutionPolicy Bypass -File "%LIBARYCHECK%" -dir "%WORK_DIR%" -threads "%THREADL%"
goto submenu
